...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			String fourAsString = JOptionPane.showInputDialog("enter the number 4 please?");
			
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
		String sixAsString	= JOptionPane.showInputDialog("now enter the number 6 please?");
			
// 4) Print the addition of fourAsString and sixAsString using JOptionPane 
JOptionPane.showInputDialog(fourAsString+ sixAsString);
			// Did you notice 46 instead of 4 + 6 = 10?
			
			// 5) Ask the user to enter number 5 and hold it in the variable fiveAsString 
			String fiveAsString = JOptionPane.showInputDialog("Can you enter the number 5 for me now? Thanks!");
			// 6) Print the addition of the variables fourAsString, sixAsString, and fiveAsString 
			JOptionPane.showInputDialog(fourAsString+sixAsString+fiveAsString);
...
JOptionPane.showInputDialog(fourAsInt+sixAsInt);
			...
			JOptionPane.showInputDialog(fourAsInt+sixAsInt+fiveAsInt);
